...
quarantine = statsItems[5].find_all("span", class_="quantity-numver")[0].text.rstrip()
hospitalize = statsItems[6].find_all("span", class_="quantity-numver")[0].text.rstrip()
clinicHotels = statsItems[7].find_all("span", class_="quantity-numver")[0].text.rstrip()
